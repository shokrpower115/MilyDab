        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Certifications_Professionals_ProfessionalId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ContactRequests_Customers_CustomerId",
                        column: x => x.CustomerId,
                        principalTable: "Customers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ContactRequests_Professionals_ProfessionalId",
                        column: x => x.ProfessionalId,
                        principalTable: "Professionals",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Budgets_Professionals_ProfessionalId",
                        column: x => x.ProfessionalId,
                        principalTable: "Professionals",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Servicios de reparación y instalación de tuberías", "Plomería" },
                    { 2, "Trabajos eléctricos y reparación", "Electricidad" },
                    { 3, "Servicios de pintura interior y exterior", "Pintura" },
                    { 4, "Trabajos de carpintería y muebles", "Carpintería" },
                    { 5, "Servicios de limpieza profesional", "Limpieza" },
                    { 6, "Reparaciones varias en el hogar", "Reparación General" }
                });

            migrationBuilder.CreateIndex(
                name: "IX_Budgets_ProfessionalId",
                table: "Budgets",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Certifications_ProfessionalId",
                table: "Certifications",
                column: "ProfessionalId");

            migrationBuilder.CreateIndex(
                name: "IX_ContactRequests_CustomerId",
                table: "ContactRequests",
                column: "CustomerId");

            migrationBuilder.CreateIndex(
                name: "IX_ContactRequests_ProfessionalId",
                table: "ContactRequests",
                column: "ProfessionalId");
