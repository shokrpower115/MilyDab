...
import { RegisterProfessionalRequest } from '../../../../shared/models/auth.models';
        ...
        <div class="card card-custom">
          <div class="card-body">
            <div class="text-center mb-4">
              <h1 class="h3 fw-bold text-dark">Regístrate como Profesional</h1>
              <p class="text-muted mt-2">Ofrece tus servicios y conecta con clientes</p>
            </div>
            ...
            <form [formGroup]="registerForm" (ngSubmit)="onSubmit()">
              ...
              <div class="col-12 col-md-6">
                ...
                >
                  ...
                  <option value="4">Reparación General</option>
                  <option value="5">Pintura</option>
                  <option value="6">Limpieza</option>
                </select>
                <p *ngIf="isFieldInvalid('specialtyId')" class="text-danger small mt-1">Especialidad requerida</p>
              </div>
              ...
              <div class="col-12 col-md-6">
                ...
                <input
                  ...
                  placeholder="5"
                />
                <p *ngIf="isFieldInvalid('yearsOfExperience')" class="text-danger small mt-1">Experiencia requerida</p>
              </div>
              ...
              <div class="col-12 col-md-6">
                ...
                <input
                  ...
                  placeholder="50"
                />
                <p *ngIf="isFieldInvalid('hourlyRate')" class="text-danger small mt-1">Tarifa requerida</p>
              </div>
            ...
            <div class="mt-3">
              ...
              ></textarea>
              <p *ngIf="isFieldInvalid('bio')" class="text-danger small mt-1">Biografía requerida</p>
            </div>
...
export class RegisterProfessionalComponent {
  ...
  onSubmit(): void {
    ...
    const userData: RegisterProfessionalRequest = {
      ...this.registerForm.value,
      specialtyId: parseInt(this.registerForm.value.specialtyId)
    };

    this.authService.registerProfessional(userData).subscribe({
      next: (response) => {
